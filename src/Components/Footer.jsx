...
function Footer() {
  return (
    <div>
      <div style={{ width: "100%", height: "300px" }} className='d-flex flex-wrap justify-content-evenly align-items-center bg-secondary'>
        ...
        <div className="connections">
          ...
          <form className='d-flex'>
            <input className='me-2 rounded' type="email" placeholder='Enter your email Id' />
            <input className='btn rounded bg-dark text-light' type="button" value="Subscribe" />
          </form>
          <div className='icons d-flex justify-content-between p-3'>
            <Link style={{ textDecoration: "none" }} className='text-light' to={'https://react-bootstrap.github.io/'}>
